...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1517343985, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1517343985; // October 17, 2017 4:30:00 AM
        ...
        nBlockEnforceInvalidUTXO = 90802; //Start enforcing the invalid UTXO's
